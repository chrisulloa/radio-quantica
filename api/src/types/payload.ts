...
export interface Config {
  ...
  collectionsSelect: {
    ...
    restartLibretime: RestartLibretimeSelect<false> | RestartLibretimeSelect<true>;
  ...
  jobs: {
    tasks: {
      restartServer: TaskRestartServer;
      inline: {
        input: unknown;
        output: unknown;
      };
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "restartLibretime".
 */
export interface RestartLibretime {
  id: string;
  /**
   * Debug log of results
   */
  results?: string | null;
  taskFinished?: boolean | null;
  updatedAt: string;
  createdAt: string;
}
/**
...
export interface PayloadJob {
  ...
  log?:
    ...
    | null;
  taskSlug?: ('inline' | 'restartServer') | null;
  queue?: string | null;
...
export interface PayloadLockedDocument {
  ...
  document?:
    ...
    | ({
        relationTo: 'restartLibretime';
        value: string | RestartLibretime;
      } | null)
    | ({
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "restartLibretime_select".
 */
export interface RestartLibretimeSelect<T extends boolean = true> {
  results?: T;
  taskFinished?: T;
  updatedAt?: T;
  createdAt?: T;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "TaskRestartServer".
 */
export interface TaskRestartServer {
  input: {
    collectionId: string;
