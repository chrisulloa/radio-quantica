...
const ShowsPageHeader = () => (
  <Head>
    <title>Latest Shows - PARTICLE.FM</title>
    <meta name="twitter:card" content="summary_large_image" />
    <meta name="twitter:site" content="@particlefm" />
    <meta name="twitter:title" content="PARTICLE.FM | Latesst Shows" />
    <meta name="twitter:description" content="Particle FM Latest Shows" />
    <meta
      name="twitter:image"
    ...
    <meta property="og:title" content="Particle FM Latest Shows"></meta>
    <meta property="og:type" content="website"></meta>
    <meta property="og:url" content="https://particle.fm/latest"></meta>
    <meta property="og:description" content="Particle FM Latest Shows" />
    <meta
      property="og:image"
      content="https://cdn.particle.fm/socials/particle-fm-socials-banner.jpg"
    ></meta>
  ...
  return (
    <div className="px-5 sm:px-10 w-full md:w-10/12 xl:w-8/12 mb-5">
      ...
      <form
        autoComplete={"off"}
        id="chatInput"
        className="flex flex-row mb-8 divide-white border border-white justify-end"
      ...
      >
        <input
          ...
          ref={searchRef}
        ></input>
        <div className="tracking-widerounded text-sm text-white p-2">
      ...
      {isMobileAndNotLoading && hasNext && (
        <button
          type="button"
          className="mt-4 flex w-full justify-center group border px-11 rounded-md border-white text-white"
