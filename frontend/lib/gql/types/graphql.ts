...
export type NewsPostQuery = { NewsPost: { authorId: string | null, authorName: string | null, blurb: string | null, content: LexicalRootDoc | null, createdAt: string | null, id: string, publishDate: string | null, slug: string | null, title: string | null, previewBanner: { url: string | null, width: number | null, height: number | null } | null, tags: Array<{ name: string, id: string }> | null } | null };
